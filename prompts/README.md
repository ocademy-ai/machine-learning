<p align="center"><h1>🧠 Awesome ChatGPT Prompts for AI Teaching and Learning</h1></p>
...
Welcome to the "Awesome ChatGPT Prompts for AI Teaching and Learning" repository! This is a collection of prompt examples to be used with the ChatGPT model for teachers and students who are interested with AI.

The [ChatGPT](https://chat.openai.com/chat) model is a large language model trained by [OpenAI](https://openai.com) that is capable of generating human-like text. By providing it with a prompt, it can generate responses that continue the conversation or expand on the given prompt.

In this repository, you will find a variety of prompts that can be used with ChatGPT. We encourage you to [add your own prompts](https://github.com/ocademy-ai/machine-learning/edit/main/prompts/README.md) to the list, and to use ChatGPT to generate new prompts as well.

To get started, simply clone this repository and use the prompts in the `prompts/README.md` file as input for ChatGPT. You can also use the prompts in this file as inspiration for creating your own.
...
## Act as an educator, assistant or tool
...
### Act as a course creator

Contributed by: [@Sami](https://flowgpt.com/@sami-2042)
...
> 
### Act as A Comprehensive Study Plan for College-Bound Students

Contributed by: [@Crazybuffon](https://flowgpt.com/user/ONet2UzvZ-tdrmVrerXUM)
...
### Act as a LessonPlannerGPT

Contributed by: [@PigOnPCin4K {LEGENDS}](https://flowgpt.com/@pigonpcin4k-legends)
...
### Act as a CourseCraftopia

Contributed by: [Martinus Alexander “Voytas” Napier](https://flowgpt.com/user/ga6hbHXMZyTdOeSu2rgSv)
...
### Act as a Super Actionable Study Planner

Contributed by: [@fiona-zhou](https://flowgpt.com/@fiona-zhou)
...
### Act as a Quick Course Planner

Contributed by: [@rajnath-singh](https://flowgpt.com/@rajnath-singh)
...
Contributed by: [@infinityspeed](https://flowgpt.com/@infinityspeed)
...
## Act as a career or self-development coach
...
## Act as a content creator, assistant or tool
...
## Act as an IT specialist or engineer
...
### Act as a Software Quality Assurance Engineer
...
## Act as a well-known application
...
## Act as a Programming Language Interpreter
